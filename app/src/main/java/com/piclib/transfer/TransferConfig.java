...
public final class TransferConfig {
    ...
    private TransferImageLoader imageLoader;
    ...
    public TransferImageLoader getImageLoader() {
        return imageLoader;
    }

    public void setImageLoader(TransferImageLoader imageLoader) {
...
//        private TransferImageLoader imageLoader;
         ...
         * TransferImageLoader 接口定义自己的图片加载器
         */
//        public Builder setImageLoader(TransferImageLoader imageLoader) {
//            this.imageLoader = imageLoader;
//            return this;
//        }
        ...
        public TransferConfig bindImageviewList(List<ImageView> list) {
