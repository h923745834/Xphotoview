...
//    private OnTransfereeStateChangeListener transListener;
    ...
    private void createDialog() {
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.KITKAT) {
            transLayout.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE
    ...
    private void fillOriginImages() {
        ...
        }else if(transConfig.getImageViewList()!=null&&
                transConfig.getImageViewList().size()>0){
...
//    }
     ...
     * 清除 transferee 缓存
     */
//    public static void clear(TransferImageLoader imageLoader) {
